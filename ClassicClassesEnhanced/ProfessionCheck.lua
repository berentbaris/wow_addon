----------------------------------------------------------------------
-- ClassicClassesEnhanced — Profession Tracking
--
...
--
-- Results are stored in CCE_CharDB.profResults so the requirements
...
function PC.RunCheck()
    ...
    if CCE_CharDB then
        CCE_CharDB.profResults = results
    end
    return results
end
...
function PC.GetResults()
    return CCE_CharDB and CCE_CharDB.profResults or {}
end
