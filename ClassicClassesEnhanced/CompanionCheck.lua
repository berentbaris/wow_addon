----------------------------------------------------------------------
-- ClassicClassesEnhanced — Companion (Non-Combat Pet) Tracking
--
...
CC.CompanionDB = {
    ...
    ["Cat"] = {
        ...
        notes = "Vendor in Elwynn Forest or Dalaran Spellscribe drop",
    },
...
----------------------------------------------------------------------
-- Reset (called on /cce pick, /cce reset)
----------------------------------------------------------------------
...
function CC.RunCheck()
    ...
    CCE_CharDB.companionResults = result
