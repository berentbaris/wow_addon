...
HCE.LoreData = {
    ...
    ["Warmage"] = "Warmages are spellcasters who accompany soldiers into the heart of battle. The generations of warfare on Azeroth have given warmages time to hone useful spells into simple and secret rituals, called battlemagics, which are passed from warmage to another. They can wield a sword in one hand, and a staff in the other. As warmages accompany warriors into battle, they become better at defending themselves than other wizards. They fight on the front lines alongside footmen using frost magic to crowd control.",
