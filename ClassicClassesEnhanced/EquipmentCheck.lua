----------------------------------------------------------------------
-- ClassicClassesEnhanced — Equipment Tracking
--
...
-- NOW, not acquisition history.  Results are stored in CCE_CharDB so
...
----------------------------------------------------------------------
-- Persistent state: store last check results in CCE_CharDB so the
...
function EQ.RunCheck()
    ...
    if CCE_CharDB then
        CCE_CharDB.equipResults = results
    end
    return results
end
...
function EQ.GetResults()
    return CCE_CharDB and CCE_CharDB.equipResults or {}
end
...
function EQ.CheckAndWarn()
    ...
    -- pairs() gives a live view into CCE_CharDB.equipResults, and
